...
const DOWNLOAD_PLACEHOLDER_VALUES = new Set(["N/A", "No rows extracted"]);

const isResultFileDownloadable = (filename) => filename && !DOWNLOAD_PLACEHOLDER_VALUES.has(filename);
...
export default function UploadBox() {
  ...
  const downloadLinks = useMemo(() => {
    ...
    return entries
      .filter(entry => isResultFileDownloadable(entry.filename))
      .map(entry => ({
        ...entry,
